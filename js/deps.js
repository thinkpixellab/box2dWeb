...
goog.addDependency("../../../demo/demo.js", ['Demo', 'Demo.FrameEvent'], ['box2d.AABB', 'box2d.BodyDef', 'box2d.BoxDef', 'box2d.CircleDef', 'pl.ex', 'box2d.World', 'demoDraw', 'demos.compound', 'demos.crank', 'demos.pendulum', 'demos.stack', 'demos.top', 'goog.events', 'goog.events.EventTarget', 'goog.events.EventType', 'goog.math.Vec2', 'goog.Timer', 'pixelLab.FpsLogger']);
...
goog.addDependency("../../../pl/examples/deps.js", [], []);
goog.addDependency("../../../pl/examples/tile.js", [], ['goog.debug.LogManager', 'goog.math.Coordinate', 'goog.Timer', 'goog.math.Vec2', 'pl.ex', 'pl.retained.Container', 'pl.retained.Stage', 'pl.retained.TileLayer', 'pl.FpsLogger', 'pl.DebugDiv']);
goog.addDependency("../../../pl/examples/transition.js", [], ['goog.debug.LogManager', 'goog.math.Coordinate', 'goog.Timer', 'goog.math.Vec2', 'pl.ex', 'pl.retained.Stage', 'pl.retained.Text', 'pl.retained.Container', 'pl.FpsLogger', 'pl.DebugDiv']);
